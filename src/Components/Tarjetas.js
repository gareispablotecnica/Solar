            ...
            <View style={styles.tarjeta}>
             ...
             <View style={styles.tarjeta}>
                ...
                <View style={styles.info}>
                    ...
                    <Text style={styles.Descripcion}>Es el segundo planeta desde el Sol y tiene un tamaño similar al de la Tierra. Su atmósfera es muy densa y rica en dióxido de carbono, lo que provoca temperaturas extremadamente altas.</Text>
                    <Text style={styles.km}>41 millones de km.</Text>
                </View>
            </View>
